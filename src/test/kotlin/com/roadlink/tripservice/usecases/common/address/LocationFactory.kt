...
object LocationFactory {
    ...
    fun escobar() = Location(latitude = -34.33681478419013, longitude = -58.77479442445022, alias = "escobar")
    fun pilar() = Location(latitude = -34.460306023447785, longitude = -58.9036696997733, alias = "pilar")
    fun rosario() = Location(latitude = -32.946427759972906, longitude = -60.67466957660417, alias = "rosario")

    fun avDelLibertador_5000() = Location(latitude = -34.563818, longitude = -58.436607, alias = "AvDelLibertador 5000")
}