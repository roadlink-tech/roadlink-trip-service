...
-- Creating Trip:
--      Rosario -> Bs As
INSERT INTO tripservice_db.section (arrival_latitude, arrival_longitude, booked_seats,
                                    departure_latitude,
                                    departure_longitude, distance_in_meters,
                                    initial_amount_of_seats,
                                    arrival_estimated_arrival_time,
                                    departure_estimated_arrival_time, trip_id,
                                    arrival_city, arrival_country, arrival_full_address,
                                    arrival_house_number,
                                    arrival_street, departure_city, departure_country,
                                    departure_full_address,
                                    departure_house_number, departure_street, driver_id, id,
                                    vehicle_id,
                                    departure_point)
VALUES (-34.62819801818182, -58.39189034949495, 0, -32.9678575, -60.6619963, 0, 4,
        ...
        'Combate de los Pozos 1682, Buenos Aires', '1682', 'Combate de los Pozos', 'Rosario',
        'Argentina',
...
INSERT INTO tripservice_db.trip (arrival_latitude, arrival_longitude, available_seats,
                                 departure_latitude,
                                 departure_longitude, arrival_estimated_arrival_time,
                                 departure_estimated_arrival_time,
                                 arrival_city, arrival_country, arrival_full_address,
                                 arrival_house_number,
                                 arrival_street, departure_city, departure_country,
                                 departure_full_address,
                                 departure_house_number, departure_street, driver_id, id, status,
                                 vehicle_id, policies, restrictions)
VALUES (-34.62819801818182, -58.39189034949495, 4, -32.9678575, -60.6619963,
        '2024-05-03 14:29:00.000000',
        '2024-05-03 10:30:00.000000', 'Buenos Aires', 'Argentina',
        'Combate de los Pozos 1682, Buenos Aires', '1682',
        'Combate de los Pozos', 'Rosario', 'Argentina', 'Rueda 2400, Rosario', '2400', 'Rueda',
        '123e4567-e89b-12d3-a456-426614174001', '1e2cfc5b-397f-4ffe-a5d4-4078a46bea01',
        'NOT_STARTED',
...
VALUES (-31.42056375510204, -64.19165538979591, 4, -34.54025770408163, -58.47450726734694,
        ...
        'Avenida Cabildo 4853, Buenos Aires', '4853', 'Avenida Cabildo',
        '123e4567-e89b-12d3-a456-426614174004',
        '1a4eee4f-3c6a-478d-b55a-cf4911e5b7b2', 'NOT_STARTED',
        'b85df607-16cf-4da2-8f2e-51baa90a1748', '[]', '[]');

-- Meeting points
INSERT INTO tripservice_db.trip_jpaentity_meeting_points (latitude, longitude,
                                                          estimated_arrival_time, city, country,
                                                          full_address, house_number, street,
                                                          trip_jpaentity_id)
VALUES (-34.4569996, -58.9131929,
        DATE_ADD(CURRENT_DATE, INTERVAL 1 DAY) + INTERVAL '16:30' HOUR_MINUTE, 'Pilar',
        'Argentina', 'Pedro Lagrave 600, Pilar', '600', 'Pedro Lagrave',
...
VALUES (-34.4569996, -58.9131929, 0, -34.54025770408163, -58.47450726734694, 0, 4,
        ...
        DATE_ADD(CURRENT_DATE, INTERVAL 1 DAY) + INTERVAL '15:00' HOUR_MINUTE,
        '1a4eee4f-3c6a-478d-b55a-cf4911e5b7b2',
        'Pilar', 'Argentina', 'Pedro Lagrave 600, Pilar', '600', 'Pedro Lagrave', 'Buenos Aires',
        'Argentina',
        'Avenida Cabildo 4853, Buenos Aires', '4853', 'Avenida Cabildo',
        '123e4567-e89b-12d3-a456-426614174004',
...
VALUES (-41.1166129, -71.4049374, 4, -34.62819801818182, -58.39189034949495,
        ...
        'Avenida Exequiel Bustillo 1500, San Carlos de Bariloche', '1500',
        'Avenida Exequiel Bustillo', 'Buenos Aires',
        'Argentina', 'Combate de los Pozos 1682, Buenos Aires', '1682', 'Combate de los Pozos',
        '123e4567-e89b-12d3-a456-426614174004', '705b6389-b1be-4215-b7eb-a3093d96eb3d',
        'NOT_STARTED',
        'b85df607-16cf-4da2-8f2e-51baa90a1748', '[]', '[]');
...
INSERT INTO tripservice_db.trip_jpaentity_meeting_points (latitude, longitude,
                                                          ...
                                                          full_address, house_number, street,
                                                          trip_jpaentity_id)
VALUES (-38.04862065306122, -57.56475636734694,
        DATE_ADD(CURRENT_DATE, INTERVAL 20 DAY) + INTERVAL '21:00' HOUR_MINUTE,
        'Mar del Plata', 'Argentina',
        'Eduardo Carasa 3998, Mar del Plata', '3998', 'Eduardo Carasa',
...
VALUES (-38.04862065306122, -57.56475636734694, 0, -34.62819801818182, -58.39189034949495, 0, 4,
        ...
        DATE_ADD(CURRENT_DATE, INTERVAL 19 DAY) + INTERVAL '15:00' HOUR_MINUTE,
        '705b6389-b1be-4215-b7eb-a3093d96eb3d',
        'Mar del Plata', 'Argentina', 'Eduardo Carasa 3998, Mar del Plata', '3998',
        'Eduardo Carasa', 'Buenos Aires',
        'Argentina', 'Combate de los Pozos 1682, Buenos Aires', '1682', 'Combate de los Pozos',
...
VALUES (-37.378776110204086, -64.60683112857143, 0, -38.04862065306122, -57.56475636734694, 0, 4,
        ...
        DATE_ADD(CURRENT_DATE, INTERVAL 19 DAY) + INTERVAL '21:00' HOUR_MINUTE,
        '705b6389-b1be-4215-b7eb-a3093d96eb3d',
        'Municipio de General Acha', 'Argentina', 'Padre Buodo 1035, Municipio de General Acha',
        '1035', 'Padre Buodo',
        'Mar del Plata', 'Argentina', 'Eduardo Carasa 3998, Mar del Plata', '3998',
        'Eduardo Carasa',
...
VALUES (-37.378776110204086, -64.60683112857143,
        ...
        '1a4eee4f-3c6a-478d-b55a-cf4911e5b7b3', 'NOT_STARTED',
        'b85df607-16cf-4da2-8f2e-51baa90a1748', '[]', '[]');
...
INSERT INTO tripservice_db.trip_leg_solicitudes (id, trip_plan_solicitudes_jpaentity_id,
                                                 authorizer_id, passenger_id,
                                                 status)
VALUES ('6680dfbb-1e46-49bd-9e93-605cb49171e2', '1e7db8a8-abd7-49d8-82b7-562e9e711f3e',
        '123e4567-e89b-12d3-a456-426614174004', '123e4567-e89b-12d3-a456-426614174001',
        'PENDING_APPROVAL');
...
VALUES ('6680dfbb-1e46-49bd-9e93-605cb49171e4', '1e7db8a8-abd7-49d8-82b7-562e9e711f3f',
        '123e4567-e89b-12d3-a456-426614174004', '123e4567-e89b-12d3-a456-426614174003',
        'PENDING_APPROVAL');
